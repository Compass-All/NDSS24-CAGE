...
const mmap_region_t plat_arm_mmap[] = {
	...
	V2M_MAP_IOFPGA,
	MAP_REGION_FLAT(0x20000000,(0x2b400000-0x20000000),MT_DEVICE | MT_RW |MT_SECURE),
	MAP_REGION_FLAT(0x2b400000,(0x2b500000-0x2b400000),MT_DEVICE | MT_RW |MT_ROOT),
	MAP_REGION_FLAT(0x2b500000,(0x2c200000-0x2b500000),MT_DEVICE | MT_RW |MT_SECURE),
#if FVP_GICR_REGION_PROTECTION
	MAP_GICD_MEM,
	MAP_GICR_MEM,
#else
...
#endif
	MAP_REGION_FLAT(0x06000000,(0x07000000-0x06000000),MT_MEMORY | MT_RW |MT_SECURE), //GPT
	
	MAP_REGION_FLAT(0xa0000000,(0xa2000000-0xa0000000),MT_MEMORY | MT_RW |MT_ROOT), //GPT
	...
	MAP_REGION_FLAT(0x8a0000000,0x10000000,MT_MEMORY | MT_RW |MT_REALM), //Real Task
	MAP_REGION_FLAT(0x8b0000000,0x10000000,MT_MEMORY | MT_RW |MT_REALM), //Real GPU page table	
	{0}
};
